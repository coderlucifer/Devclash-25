      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-md transition flex flex-col items-center justify-center py-8 cursor-pointer group">
            ...
            <button onClick={()=>navigate("/duel-test")} className="mt-4 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded transition">Start Duel</button>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-md transition flex flex-col items-center justify-center py-8 cursor-pointer group">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">AI advisor</h3>
            <p className="text-gray-600 text-center">Take advice based on your past performances</p>
            <button onClick={()=>navigate("/aiprogresstracker")} className="mt-4 bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded transition">Join Group</button>
          </div>
